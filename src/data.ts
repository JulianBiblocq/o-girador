...
export const i18n = {
  pt: {
    ...
    seqDesktopKeys: "• Espaço : Reproduzir / Pausar<br>• Ctrl+Z / Ctrl+Y : Desfazer / Refazer<br>• Ctrl+C / Ctrl+V : Copiar / Colar padrão<br>• Ctrl+A / Ctrl+X : Selecionar tudo / Recortar<br>• Delete / Backspace : Limpar célula (mantenha pressionado durante a reprodução para apagar ao vivo)",
  ...
  fr: {
    ...
    seqDesktopKeys: "• Espace : Lecture / Pause<br>• Ctrl+Z / Ctrl+Y : Annuler / Rétablir<br>• Ctrl+C / Ctrl+V : Copier / Coller le motif<br>• Ctrl+A / Ctrl+X : Tout sélectionner / Couper<br>• Suppr / Retour arrière : Vider une case (maintenir pendant la lecture pour gommer en direct)",
